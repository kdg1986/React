  ...
  _createClass(DatetimePicker, [{
    ...
    value: function componentDidMount() {
      var _props = this.props,
          ...
          props = _objectWithoutProperties(_props, ['children', 'readOnly', 'type', 'wrapper', 'className', 'style', 'iconSuccess', 'iconClear', 'iconOpen','placeholder','startDate', 'endDate', 'defaultDate', 'defaultValue', 'isDefaultValue']);
